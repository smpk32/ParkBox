...
<script type="text/javascript">
	$(document).ready(function() {
		...
		// 시간표상 시작시간 앞 두자리 잘라서 저장
		var startTimeSet = new Array();
		$('.startTime').each(function() {
			var time = $(this).text().substring(0, 2);
			startTimeSet.push(time);
		});

		//시간표에 있는 시간만 클릭할 수 있게 활성화
		$('.hourBtn').each(function(i, element) {
			var target = $(this).text(); // 시간
			if ($.inArray(target, startTimeSet) < 0) { //inArray(찾을값,배열): 포함되어있으면index반환
	...
	$(function() {
		...
		//시간(숫자) 클릭했을때 해당 시간에 하는 첫번째 시간표가 맨위에 오게 스크롤 이동
		$('.hourBtn')
				.click(
						function() {
							var target = $(this).text(); //클릭한 숫자

							$('.startTime')
									.each(
											function(i, element) {
												var st = $(this).text()
														.substring(0, 2); // 시간표상 시작시간 앞 두자리 잘라서 저장
												if (target == st) {
													var moveTo = $(this)
															.parent().parent()
															.parent().offset().top; // 변경할 위치
													var orign = $(
															'#selectTime li')
															.offset().top; // 기본 스크롤 위치	
													var offset = moveTo - orign; // 움직일 위치(기본-변경)
													...
													return false; // 상위값으로 변경 후 each함수 종료
												}
											});
						});
});
	...
	function addInfoArea(n, info) {
		if (n != 4) {
			...
			$('#booktheaterInfo').append(
					'<div><span class="newInfo">' + info + '</span></div>'); //n이4라면(screen) 영화관정보영역에 보이게 추가함
		}
	...
	// 영화,극장,날짜 모두 선택했는지 확인하고 시간표 보여주기
	function checkSelected() {
		var m = $('#bookingInfoForm input').eq(0).val();
		var t = $('#bookingInfoForm input').eq(1).val();
		var d = $('#bookingInfoForm input').eq(2).val();

		if (isEmpty(m) && isEmpty(t) && isEmpty(d)) {
			$('#selectTime').show();
			$('#unselectTime').hide();
		}
...
<body>
	<div class="container">
						...
						<div class="navSection">
							<ul class="nav nav-tabs nav-justified">
								<li class="nav-item"><a class="nav-link active"
									data-toggle="tab" href="#byRank">예매율순</a></li>
								<li class="nav-item"><a class="nav-link" data-toggle="tab"
									href="#byName">가나다순</a></li>
							</ul>
						</div>
							...
							<div id="byRank" class="tab-pane active">
								<ul class="list-group scroll">
									<li class="list-group-item">
										<!-- 실제로는 li한개만 for문 안에 들어감 --> <a href="#"> 12 <!-- 관람가표시 이미지로 삽입 -->
											<span class="movie">삼진그룹영어토익반</span>
									</a>
									</li>
									<li class="list-group-item"><a href="#">12<span
											class="movie">담보</span></a></li>
									<li class="list-group-item"><a href="#">12<span
											class="movie">담보</span></a></li>
									<li class="list-group-item"><a href="#">12<span
											class="movie">테넷</span></a></li>
									<li class="list-group-item"><a href="#">12<span
											class="movie">테넷</span></a></li>
									<li class="list-group-item"><a href="#">15<span
											class="movie">위플래쉬</span></a></li>
									<li class="list-group-item"><a href="#">15<span
											class="movie">위플래쉬</span></a></li>
									<li class="list-group-item"><a href="#">12<span
											class="movie">도굴</span></a></li>
									<li class="list-group-item"><a href="#">12<span
											class="movie">도굴</span></a></li>
									<li class="list-group-item"><a href="#">15<span
											class="movie">소리도없이</span></a></li>
									<li class="list-group-item"><a href="#">15<span
											class="movie">소리도없이</span></a></li>
									<li class="list-group-item"><a href="#">청<span
											class="movie">바스켓볼다이어리</span></a></li>
									<li class="list-group-item"><a href="#">청<span
											class="movie">바스켓볼다이어리</span></a></li>
									<li class="list-group-item"><a href="#">12<span
											class="movie">엣지오브투모로우</span></a></li>
									<li class="list-group-item"><a href="#">12<span
											class="movie">엣지오브투모로우</span></a></li>
									<li class="list-group-item"><a href="#">청<span
											class="movie">다만악에서구하소서파이널컷</span></a></li>
								</ul>
							</div>
							<!-- 가나다순 -->
				...
				<div class="col-4 bookSection">
					...
					<div class="bookContents">
						...
						<div class="navSection">
							<ul class="nav nav-tabs nav-justified">
								<li class="nav-item"><a class="nav-link active"
									data-toggle="tab" href="#allTheater">전체</a></li>
								<li class="nav-item"><a class="nav-link" data-toggle="tab"
									href="#specialTheater">특별관</a></li>
							</ul>
						</div>
						...
						<div id="allTheater" class="tab-pane active row">
							...
							<div id="selectRegion" class="col-6">
								<ul class="list-group">
									<li class="list-group-item"><a data-toggle="tab"
										href="#seoul"><span>서울(*)</span></a></li>
									<li class="list-group-item"><a data-toggle="tab"
										href="#seoul2"><span>경기(*)</span></a></li>
								...
								<div id="seoul" class="tab-pane active">
									<ul class="list-group scroll">
										<li class="list-group-item"><a href="#"><span
												class="theaterName">강남</span></a></li>
										<li class="list-group-item"><a href="#"><span
												class="theaterName">강변</span></a></li>
										<li class="list-group-item"><a href="#"><span
												class="theaterName">건대입구</span></a></li>
										<li class="list-group-item"><a href="#"><span
												class="theaterName">구로</span></a></li>
										<li class="list-group-item"><a href="#"><span
												class="theaterName">동대문</span></a></li>
										<li class="list-group-item"><a href="#"><span
												class="theaterName">명동</span></a></li>
										<li class="list-group-item"><a href="#"><span
												class="theaterName">목동</span></a></li>
										<li class="list-group-item"><a href="#"><span
												class="theaterName">미아</span></a></li>
										<li class="list-group-item"><a href="#"><span
												class="theaterName">상암월드컵경기장</span></a></li>
										<li class="list-group-item"><a href="#"><span
												class="theaterName">성수</span></a></li>
										<li class="list-group-item"><a href="#"><span
												class="theaterName">테스트1</span></a></li>
										<li class="list-group-item"><a href="#"><span
												class="theaterName">테스트2</span></a></li>
										<li class="list-group-item"><a href="#"><span
												class="theaterName">테스트3</span></a></li>
										<li class="list-group-item"><a href="#"><span
												class="theaterName">테스트4</span></a></li>
										<li class="list-group-item"><a href="#"><span
												class="theaterName">테스트5</span></a></li>
										<li class="list-group-item"><a href="#"><span
												class="theaterName">테스트6</span></a></li>
										<li class="list-group-item"><a href="#"><span
												class="theaterName">테스트7</span></a></li>
									</ul>
								</div>
						...
						<div id="selectDate">
							<ul class="list-group scroll">
								...
								<li class="list-group-item"><input type="hidden"
									value=<%=year + "-" + realMonth + "-" + i + "&nbsp;" + dayweek%>>
									<a href="#" class="days"> <span class="dayweek"><%=dayweek%></span>
				...
				<div class="col-4 bookSection">
					...
					<div class="bookContents">
						...
						<div id="timeNav" class="navSection">
							<button type="button" id="timeLeftBtn"
								onclick="moveScrollLR(-100)">
							...
							<button type="button" id="timeRightBtn"
								onclick="moveScrollLR(+100)">
							...
							<ul class="list-group scroll">
								...
								<li class="list-group-item ">
									<div class="row timeTable ">
										<div class="col-3 movieTime">
											...
											<div>
												<span class="endTime">~12:05</span>
											</div>
											<!-- 실제로 endTime은 시작시간에 상영시간 더한 시간으로 출력 -->
										</div>
										<div class="col movieName">
											<span>도굴</span>
										</div>
										<div class="col-4 screenInfo">
											<div>
												<span class="theaterInfo">강남</span>&nbsp;&nbsp;<span
													class="screenName">1관</span>
											</div>
											<div class="seatInfo">
												<span class="seatLeft">112</span>/<span class="setAll">200</span>
											</div>
										</div>
									</div>
								</li>
								...
								<li class="list-group-item ">
									<div class="row timeTable ">
										...
										<div class="col-4 screenInfo">
											<div>
												<span class="theaterInfo">강남</span>&nbsp;&nbsp;<span
													class="screenName">3관</span>
											</div>
											<div class="seatInfo">
												<span class="seatLeft">50</span>/<span class="setAll">100</span>
											</div>
										</div>
									</div>
								</li>
								<li class="list-group-item">
									<div class="row timeTable ">
										<div class="col-3 movieTime">
											<div>
												<span class="startTime">11:30</span>
											</div>
											<div>
												<span class="endTime">~13:35</span>
											</div>
											<!-- 실제로 endTime은 시작시간에 상영시간 더한 시간으로 출력 -->
										</div>
										<div class="col movieName">
										...
										<div class="col-4 screenInfo">
											<div>
												<span class="theaterInfo">강남</span>&nbsp;&nbsp;<span
													class="screenName">2관</span>
											</div>
											<div class="seatInfo">
												<span class="seatLeft">88</span>/<span class="setAll">150</span>
											</div>
										</div>
									</div>
								</li>
								<li class="list-group-item ">
									<div class="row timeTable ">
										...
										<div class="col-4 screenInfo">
											...
											<div class="seatInfo">
												<span class="seatLeft">92</span>/<span class="setAll">200</span>
											</div>
										</div>
									</div>
								</li>
								<li class="list-group-item ">
									<div class="row timeTable ">
										<div class="col-3 movieTime">
											<div>
												<span class="startTime">13:55</span>
											</div>
											<div>
												<span class="endTime">~16:05</span>
											</div>
											<!-- 실제로 endTime은 시작시간에 상영시간 더한 시간으로 출력 -->
										</div>
										<div class="col movieName">
										...
										<div class="col-4 screenInfo">
											...
											<div class="seatInfo">
												<span class="seatLeft">100</span>/<span class="setAll">150</span>
											</div>
										</div>
									</div>
								</li>
								<li class="list-group-item "><input type="hidden"
									...
									<div class="row timeTable ">
										<div class="col-3 movieTime">
											...
											<div class="endTime"><span>~17:00</span></div>
										</div>
										<div class="col movieName">
											<span>도굴</span>
										</div>
										<div class="col-4 screenInfo">
											...
											<div class="seatInfo">
												<span class="seatLeft">54</span>/<span class="setAll">200</span>
											</div>
										</div>
									</div></li>
								<li class="list-group-item "><input type="hidden"
									...
									<div class="row timeTable ">
										<div class="col-3 movieTime">
											<div><span>16:25</span></div>
											<div class="endTime"><span>~18:30</span></div>
										</div>
										<div class="col movieName">
											<span>도굴</span>
										</div>
										<div class="col-4 screenInfo">
											...
											<div class="seatInfo">
												<span class="seatLeft">5</span>/<span class="setAll">150</span>
											</div>
										</div>
									</div></li>
								<li class="list-group-item "><input type="hidden"
									...
									<div class="row timeTable ">
										...
										<div class="col-4 screenInfo">
											...
											<div class="seatInfo">
												<span class="seatLeft">74</span>/<span class="setAll">200</span>
											</div>
										</div>
									</div></li>
								<li class="list-group-item "><input type="hidden"
									...
									<div class="row timeTable ">
										...
										<div class="col-4 screenInfo">
											...
											<div class="seatInfo">
												<span class="seatLeft">44</span>/<span class="setAll">150</span>
											</div>
										</div>
									</div></li>
								<li class="list-group-item "><input type="hidden"
									...
									<div class="row timeTable ">
										...
										<div class="col-4 screenInfo">
											...
											<div class="seatInfo">
												<span class="seatLeft">197</span>/<span class="setAll">200</span>
											</div>
										</div>
									</div></li>
								<li class="list-group-item "><input type="hidden"
		...
		<div id="InfoArea">
			...
			<div class="bookingInfo">
				<span id="booktheaterInfo">극장선택</span>
			</div>
			<i class="fas fa-ellipsis-v fa-2x"></i>
			<div class="bookingInfo">
				<span>날짜선택</span>
